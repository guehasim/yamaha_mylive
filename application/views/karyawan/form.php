		...
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>karyawan/simpan">
							...
							<div class="item form-group form-check">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" name="nik" id="first-name" class="form-control" required>
								</div>
							</div>
							...
							<div class="item form-group form-check">
								<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Departemen <span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 ">
									<input type="text" name="dept" id="first-name" class="form-control" required>
								</div>
							</div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>karyawan/update">
							...
							<div class="item form-group form-check">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" name="nik" value="<?php echo $ad->NikUser;?>" id="first-name" class="form-control" required>
								</div>
							</div>
							...
							<div class="item form-group form-check">
								...
								<div class="col-md-6 col-sm-6 ">
									<input type="text" name="dept" value="<?php echo $ad->DeptUser;?>" id="first-name" class="form-control" required>
								</div>
							</div>
