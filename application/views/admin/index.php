          ...
          <div class="">
            ...
            <div class="row">              
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <a href="<?php echo base_url() ?>admin/newAdmin"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Admin</button></a>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url() ?>admin/get?us=<?php echo $ad->ID_User; ?>" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i> Edit </a>
                        ...
                        <div class="modal fade" id="password-info-<?php echo $ad->ID_User;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content edit-dialog-modal">
                              <form class="form-validate form-horizontal " id="register_form" action="<?php echo base_url(); ?>admin/update_password" method="post">    
                                <?php
                        ...
                        <div class="modal fade" id="hapus-info-<?php echo $ad->ID_User;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content edit-dialog-modal">
                              <form class="form-validate form-horizontal " id="register_form" action="<?php echo base_url(); ?>admin/delete" method="post">    
                                <?php
                                  $this->load->helper("form");
                                ?>
                                <div class="modal-header">
